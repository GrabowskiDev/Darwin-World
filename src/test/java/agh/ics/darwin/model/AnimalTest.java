...
class AnimalTest {
    ...
    void getPosition() {
        ...
        Animal animal = new Animal(position, MapDirection.NORTH, 10, new Genes(new int[]{0, 1, 2, 3, 4, 5, 6, 7}));
    ...
    void getGenes() {
        ...
        Animal animal = new Animal(new Vector2d(2, 3), MapDirection.NORTH,10, genes);
